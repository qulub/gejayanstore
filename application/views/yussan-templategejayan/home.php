...
<!-- start slider -->
            <div id="da-slider" class="da-slider">
                <div class="da-slide">
                    ...
                    <div class="da-img"><img src="<?php echo base_url('resource')?>/images/slider1.png" alt="image01" /></div>
                </div>
                <div class="da-slide">
                    <h2>Easy management</h2>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
                    <a href="details.html" class="da-link">shop now</a>
                    <div class="da-img"><img src="<?php echo base_url('resource')?>/images/slider2.png" alt="image01" /></div>
                </div>
                <div class="da-slide">
                    <h2>Revolution</h2>
                    <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
                    <a href="details.html" class="da-link">shop now</a>
                    <div class="da-img"><img src="<?php echo base_url('resource')?>/images/slider3.png" alt="image01" /></div>
                </div>
                <div class="da-slide">
                    <h2>Quality Control</h2>
                    <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
                    <a href="details.html" class="da-link">shop now</a>
                    <div class="da-img"><img src="<?php echo base_url('resource')?>/images/slider4.png" alt="image01" /></div>
                </div>
                <nav class="da-arrows">
    ...
    <div class="main">
        ...
        <div class="grids_of_3">
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo base_url('resource')?>/images/pic1.jpg" alt=""/>
                    <h3>branded shoes</h3>
                    <div class="price">
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo base_url('resource')?>/images/pic2.jpg" alt=""/>
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo base_url('resource')?>/images/pic3.jpg" alt=""/>
                    <h3>branded tees</h3>
                    <div class="price">
                        <h4>$300<span>indulge</span></h4>
                    </div>
        ...
        <div class="grids_of_3">
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo base_url('resource')?>/images/pic4.jpg" alt=""/>
                    <h3>branded bags</h3>
                    <div class="price">
                        <h4>$300<span>indulge</span></h4>
                    </div>
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo base_url('resource')?>/images/pic5.jpg" alt=""/>
                    <h3>ems women bag</h3>
                    <div class="price">
                        <h4>$300<span>indulge</span></h4>
                    </div>
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo base_url('resource')?>/images/pic6.jpg" alt=""/>
