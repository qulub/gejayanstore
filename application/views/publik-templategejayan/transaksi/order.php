    ...
    <div class="wrap">
        <div class="main">
            ...
            <div class="grids_of_3">
                ...
                <p style="padding-left:10px;padding-bottom:5px;text-align:left">Tambah Massa Toko <input name="tambahmasa" ng-model="TambahMasa" style="width:50px" type="number" min="0" required> bulan, Rp 100.000,-/bulan</p>
